    ...
    <header className="fixed inset-x-0 top-0 z-50 h-20 border-b border-slate-200 bg-white/95 backdrop-blur">
      <div className="flex h-full items-center gap-3 px-4 sm:px-6">
        ...
        >
          ...
          <span className="text-secondary">{t('app.studioSuffix')}</span>
        </Link>
          ...
          <details className="relative">
            <summary className="flex cursor-pointer list-none items-center gap-2 rounded-md p-1.5 transition hover:bg-slate-100 [&::-webkit-details-marker]:hidden">
              ...
              <span className="hidden text-left sm:block">
                <span className="block max-w-40 truncate text-sm font-medium text-secondary">
                  {user?.name ?? t('common.unknownUser')}
                </span>
                <span className="block max-w-40 truncate text-xs text-slate-500">
                  {roleLabel ?? t('common.unknownRole')}
                </span>
              </span>
              <svg
                aria-hidden="true"
            ...
            <div className="absolute right-0 z-50 mt-2 w-64 overflow-hidden rounded-lg border border-slate-200 bg-white py-2 shadow-card">
              <div className="px-4 py-3">
                ...
                <p className="mt-1 truncate text-xs text-slate-500">
                  {user?.email ?? t('common.unknownEmail')}
                </p>
              ...
              <div className="border-t border-slate-100 px-2 pt-2">
                ...
                >
                  ...
                  >
                    <path
                      d="M10 17l5-5-5-5M15 12H3m9-8h6a3 3 0 0 1 3 3v10a3 3 0 0 1-3 3h-6"
                      stroke="currentColor"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                      strokeWidth="1.8"
