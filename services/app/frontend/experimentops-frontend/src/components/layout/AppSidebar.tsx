  ...
  return (
    ...
    >
      <div className="flex items-center justify-between border-b border-slate-100 px-4 py-4 lg:justify-end">
        <span className={`text-xs font-semibold uppercase tracking-[0.18em] text-slate-400 ${collapsed ? 'lg:hidden' : ''}`}>
          Navigation
        </span>
        <button
          ...
          type="button"
        >
          <svg aria-hidden="true" className={`h-5 w-5 transition-transform ${collapsed ? 'rotate-180' : ''}`} fill="none" viewBox="0 0 24 24">
      ...
      <nav className="flex-1 p-3">
        ...
        >
          <svg aria-hidden="true" className="h-5 w-5 shrink-0" fill="none" viewBox="0 0 24 24">
            <path d="M4 6.5A2.5 2.5 0 0 1 6.5 4h3l2 2h6A2.5 2.5 0 0 1 20 8.5v8a2.5 2.5 0 0 1-2.5 2.5h-11A2.5 2.5 0 0 1 4 16.5v-10Z" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.8" />
          </svg>
